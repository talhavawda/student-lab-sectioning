...
"""
	...
	requests removed (and also the new course requests added)
	...
	input data XML file name with "-fullsolution-<modVerNum>" appended, and saved in the problem instance's directory]
