...
def generateInputXmlFile():
	...
	modifiedStudentsFilePath = ModifiedInputProcessing.getModifiedStudentsFilePath(problemInstanceDirectoryPath)
	...
	# then include code to also generate an xml file for the new course requests, and do the same for generateUpdatedInputXmlFile()
	# where we'll name the file a different name as this will be the solution file with the old course requests removed
